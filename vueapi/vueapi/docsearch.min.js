...
!function (t, e) {
    ...
    return function (t) {
        ...
        var i = n(2), o = r(i), s = n(3), a = r(s), u = n(68), c = r(u), l = (0, o.default)(a.default);
        l.version = c.default, e.default = l, t.exports = e.default
    }, function (t, e) {
        "use strict";
        function n(t) {
            var e = function () {
                for (var e = arguments.length, n = Array(e), i = 0; i < e; i++)n[i] = arguments[i];
                return new (r.apply(t, [null].concat(n)))
            };
        ...
        }(), a = n(4), u = r(a), c = n(7), l = r(c), h = n(43), p = r(h), f = n(65), d = r(f), m = n(66), y = r(m), g = n(68), v = r(g), b = n(67), w = r(b), _ = "Usage:\n  documentationSearch({\n  apiKey,\n  indexName,\n  inputSelector,\n  [ appId ],\n  [ algoliaOptions.{hitsPerPage} ]\n  [ autocompleteOptions.{hint,debug} ]\n})", x = function () {
            function t(e) {
                var n = e.apiKey, r = e.indexName, s = e.inputSelector, a = e.appId, u = void 0 === a ? "BH4D9OD16A" : a, c = e.debug, h = void 0 !== c && c, f = e.algoliaOptions, m = void 0 === f ? {} : f, y = e.autocompleteOptions, g = void 0 === y ? {
                    debug: !1,
                    hint: !1,
                    autoselect: !0
                } : y;
                i(this, t), t.checkArguments({
                    apiKey: n,
                    indexName: r,
                    inputSelector: s,
                    debug: h,
                ...
                }), this.apiKey = n, this.appId = u, this.indexName = r, this.input = t.getInputFromSelector(s), this.algoliaOptions = o({hitsPerPage: 5}, m);
                var b = !(!g || !g.debug) && g.debug;
                g.debug = h || b, this.autocompleteOptions = g, this.client = (0, l.default)(this.appId, this.apiKey), this.client.addAlgoliaAgent("docsearch.js " + v.default), this.autocomplete = (0, p.default)(this.input, g, [{
                    source: this.getAutocompleteSource(),
                    templates: {suggestion: t.getSuggestionTemplate(), footer: d.default.footer}
                }]), this.autocomplete.on("autocomplete:selected", this.handleSelected.bind(null, this.autocomplete.autocomplete)), this.autocomplete.on("autocomplete:shown", this.handleShown.bind(null, this.input))
            }

            return s(t, [{
                key: "getAutocompleteSource", value: function () {
                    var e = this;
                    return function (n, r) {
                        e.client.search([{
                            indexName: e.indexName,
                            query: n,
                            params: e.algoliaOptions
                        }]).then(function (e) {
                            r(t.formatHits(e.results[0].hits))
                        })
                    }
                }
            }, {
                key: "handleSelected", value: function (t, e, n) {
                    t.setVal(""), window.location.href = n.url
                }
            }, {
                key: "handleShown", value: function (t, e) {
                    var n = t.offset().left + t.width() / 2, r = (0, w.default)(document).width() / 2;
                    isNaN(r) && (r = 900);
                    var i = n - r >= 0 ? "algolia-autocomplete-right" : "algolia-autocomplete-left", o = n - r < 0 ? "algolia-autocomplete-right" : "algolia-autocomplete-left", s = (0, w.default)(".algolia-autocomplete");
                    s.hasClass(i) || s.addClass(i), s.hasClass(o) && s.removeClass(o)
                }
            }], [{
                key: "checkArguments", value: function (e) {
                    if (!e.apiKey || !e.indexName)throw new Error(_);
                    if (!t.getInputFromSelector(e.inputSelector))throw new Error("Error: No input element in the page matches " + e.inputSelector)
                }
            }, {
                key: "getInputFromSelector", value: function (t) {
                    var e = (0, w.default)(t).filter("input");
                    return e.length ? (0, w.default)(e[0]) : null
                }
            }, {
                key: "formatHits", value: function (e) {
                    var n = y.default.deepClone(e), r = n.map(function (t) {
                        return t._highlightResult && (t._highlightResult = y.default.mergeKeyWithParent(t._highlightResult, "hierarchy")), y.default.mergeKeyWithParent(t, "hierarchy")
                    }), i = y.default.groupBy(r, "lvl0");
                    return w.default.each(i, function (t, e) {
                        var n = y.default.groupBy(e, "lvl1"), r = y.default.flattenAndFlagFirst(n, "isSubCategoryHeader");
                        i[t] = r
                    }), i = y.default.flattenAndFlagFirst(i, "isCategoryHeader"), i.map(function (e) {
                        ...
                        return {
                            ...
                            isSubcategoryDuplicate: o,
                            isDisplayTitleDuplicate: a,
                            isTextOrSubcatoryNonEmpty: c,
                            category: r,
                            subcategory: i,
                            title: s,
                            text: u,
                ...
                key: "formatURL", value: function (t) {
                    var e = t.url, n = t.anchor;
                    if (e) {
                        var r = e.indexOf("#") !== -1;
                        return r ? e : n ? t.url + "#" + t.anchor : e
                    }
                    return n ? "#" + t.anchor : (console.warn("no anchor nor url for : ", JSON.stringify(t)), null)
                }
            }, {
                key: "getSuggestionTemplate", value: function () {
                    var t = u.default.compile(d.default.suggestion);
                    return function (e) {
                        return t.render(e)
                    }
                }
        ...
        var r = n(5);
        r.Template = n(6).Template, r.template = r.Template, t.exports = r
    }, function (t, e, n) {
        !function (t) {
            function e(t) {
            ...
            function i(e, n, r, a) {
                ...
                for (l = r[r.length - 1]; e.length > 0;) {
                    ...
                    if (t.tags[h.tag] <= t.tags.$ || o(h, a))r.push(h), h.nodes = i(e, h.tag, r, a); else {
                        if ("/" == h.tag) {
                            if (0 === r.length)throw new Error("Closing tag without opener: /" + h.n);
                            if (c = r.pop(), h.n != c.n && !s(h.n, c.n, a))throw new Error("Nesting error: " + c.n + " vs. " + h.n);
                            return c.end = h.i, u
                        }
            ...
            function c(t) {
                return t.replace(v, "\\\\").replace(m, '\\"').replace(y, "\\n").replace(g, "\\r").replace(b, "\\u2028").replace(w, "\\u2029")
            }
            ...
            t.tags = {
                ...
                function s() {
                    v.length > 0 && (b.push({tag: "_t", text: new String(v)}), v = "")
                }

                function a() {
                    for (var e = !0, n = x; n < b.length; n++)if (e = t.tags[b[n].tag] < t.tags._v || "_t" == b[n].tag && null === b[n].text.match(d), !e)return !1;
                    return e
                }

                function u(t, e) {
                    if (s(), t && a())for (var n, r = x; r < b.length; r++)b[r].text && ((n = b[r + 1]) && ">" == n.tag && (n.indent = b[r].text.toString()), b.splice(r, 1)); else e || b.push({tag: "\n"});
                    w = !1, x = b.length
                }

                function c(t, e) {
                    var r = "=" + S, i = t.indexOf(r, e), o = n(t.substring(t.indexOf("=", e) + 1, i)).split(" ");
                    return T = o[0], S = o[o.length - 1], i + r.length - 1
                }

                var l = i.length, h = 0, p = 1, f = 2, m = h, y = null, g = null, v = "", b = [], w = !1, _ = 0, x = 0, T = "{{", S = "}}";
                for (o && (o = o.split(" "), T = o[0], S = o[1]), _ = 0; _ < l; _++)m == h ? r(T, i, _) ? (--_, s(), m = p) : "\n" == i.charAt(_) ? u(w) : v += i.charAt(_) : m == p ? (_ += T.length - 1, g = t.tags[i.charAt(_ + 1)], y = g ? i.charAt(_ + 1) : "_v", "=" == y ? (_ = c(i, _), m = h) : (g && _++, m = f), w = _) : r(S, i, _) ? (b.push({
                    tag: y,
                    n: n(v),
                    otag: T,
                    ctag: S,
                    i: "/" == y ? w - T.length : _ + S.length
                }), v = "", _ += S.length - 1, m = h, "{" == y && ("}}" == S ? _++ : e(b[b.length - 1]))) : v += i.charAt(_);
                return u(w, !0), b
            };
            var _ = {_t: !0, "\n": !0, $: !0, "/": !0};
        ...
        !function (t) {
            ...
            function i(t) {
                return t = r(t), l.test(t) ? t.replace(o, "&amp;").replace(s, "&lt;").replace(a, "&gt;").replace(u, "&#39;").replace(c, "&quot;") : t
            }
            ...
            t.Template = function (t, e, n, r) {
                ...
                r: function (t, e, n) {
                    ...
                    var a;
                    return (!h(t) || 0 !== t.length) && ("function" == typeof t && (t = this.ms(t, e, n, r, i, o, s)), a = !!t, !r && a && e && e.push("object" == typeof t ? t : e[e.length - 1]), a)
                }, d: function (t, n, r, i) {
                    var o, s = t.split("."), a = this.f(s[0], n, r, i), u = this.options.modelGet, c = null;
                    if ("." === t && h(n[n.length - 2]))a = n[n.length - 1]; else for (var l = 1; l < s.length; l++)o = e(s[l], a, u), void 0 !== o ? (c = a, a = o) : a = "";
                    return !(i && !a) && (i || "function" != typeof a || (n.push(c), a = this.mv(a, n, r), n.pop()), a)
                }, f: function (t, n, r, i) {
                    for (var o = !1, s = null, a = !1, u = this.options.modelGet, c = n.length - 1; c >= 0; c--)if (s = n[c], o = e(t, s, u), void 0 !== o) {
                        a = !0;
                        break
                    }
            ...
            var o = /&/g, s = /</g, a = />/g, u = /\'/g, c = /\"/g, l = /[&<>\"\']/, h = Array.isArray || function (t) {
        ...
        function i() {
            var t = "Not implemented in this environment.\nIf you feel this is a mistake, write to support@algolia.com";
            throw new l.AlgoliaSearchError(t)
        }

        t.exports = r;
        var o = n(9), s = n(15), a = n(16), u = n(27), c = n(10), l = n(13);
        c(r, u), r.prototype.deleteIndex = function (t, e) {
        ...
        }, r.prototype.moveIndex = function (t, e, n) {
        ...
        }, r.prototype.copyIndex = function (t, e, n) {
        ...
        }, r.prototype.getLogs = function (t, e, r) {
            var i = n(18), o = {};
        ...
        }, r.prototype.listIndexes = function (t, e) {
            var n = "";
        ...
        }, r.prototype.addUserKeyWithValidity = s(function (t, e, n) {
            return this.addUserKey(t, e, n)
        }, a("client.addUserKeyWithValidity()", "client.addUserKey()")), r.prototype.updateUserKey = function (t, e, r, i) {
            var o = n(22), s = "Usage: client.updateUserKey(key, arrayOfAcls[, params, callback])";
            ...
            this._batch = []
        }, a("client.startQueriesBatch()", "client.search()")), r.prototype.addQueryInBatch = s(function (t, e, n) {
            this._batch.push({indexName: t, query: e, params: n})
        }, a("client.addQueryInBatch()", "client.search()")), r.prototype.sendQueriesBatch = s(function (t) {
            return this.search(this._batch, t)
        }, a("client.sendQueriesBatch()", "client.search()")), r.prototype.batch = function (t, e) {
            var r = n(22), i = "Usage: client.batch(operations[, callback])";
        ...
        var i = n(10), o = n(11), s = n(15), a = n(16), u = n(24), c = n(13), l = s(function () {
        }, a("forwardToSlaves", "forwardToReplicas"));
        t.exports = r, i(r, o), r.prototype.addObject = function (t, e, n) {
            var r = this;
        ...
        }, r.prototype.addObjects = function (t, e) {
            var r = n(22), i = "Usage: index.addObjects(arrayOfObjects[, callback])";
            if (!r(t))throw new Error(i);
            for (var o = this, s = {requests: []}, a = 0; a < t.length; ++a) {
                var u = {action: "addObject", body: t[a]};
                s.requests.push(u)
            }
        ...
        }, r.prototype.partialUpdateObject = function (t, e, n) {
            1 !== arguments.length && "function" != typeof e || (n = e, e = void 0);
            var r = this, i = "/1/indexes/" + encodeURIComponent(r.indexName) + "/" + encodeURIComponent(t.objectID) + "/partial";
            return e === !1 && (i += "?createIfNotExists=false"), this.as._jsonRequest({
                method: "POST",
                url: i,
                body: t,
                hostType: "write",
        ...
        }, r.prototype.partialUpdateObjects = function (t, e) {
            var r = n(22), i = "Usage: index.partialUpdateObjects(arrayOfObjects[, callback])";
            if (!r(t))throw new Error(i);
            for (var o = this, s = {requests: []}, a = 0; a < t.length; ++a) {
                var u = {action: "partialUpdateObject", objectID: t[a].objectID, body: t[a]};
                s.requests.push(u)
            }
            return this.as._jsonRequest({
                method: "POST",
        ...
        }, r.prototype.saveObject = function (t, e) {
            var n = this;
            return this.as._jsonRequest({
                method: "PUT",
        ...
        }, r.prototype.saveObjects = function (t, e) {
            var r = n(22), i = "Usage: index.saveObjects(arrayOfObjects[, callback])";
            if (!r(t))throw new Error(i);
            for (var o = this, s = {requests: []}, a = 0; a < t.length; ++a) {
                var u = {action: "updateObject", objectID: t[a].objectID, body: t[a]};
                s.requests.push(u)
            }
            return this.as._jsonRequest({
                method: "POST",
        ...
        }, r.prototype.deleteObject = function (t, e) {
            if ("function" == typeof t || "string" != typeof t && "number" != typeof t) {
                ...
                return e = t, "function" == typeof e ? e(n) : this.as._promise.reject(n)
            }
            var r = this;
            return this.as._jsonRequest({
                method: "DELETE",
                url: "/1/indexes/" + encodeURIComponent(r.indexName) + "/" + encodeURIComponent(t),
                hostType: "write",
                callback: e
            })
        }, r.prototype.deleteObjects = function (t, e) {
            var r = n(22), i = n(23), o = "Usage: index.deleteObjects(arrayOfObjectIDs[, callback])";
        ...
        }, r.prototype.deleteByQuery = function (t, e, r) {
            function i(t) {
                if (0 === t.nbHits)return t;
                var e = h(t.hits, function (t) {
                    return t.objectID
                });
                return p.deleteObjects(e).then(o).then(s)
            }
            ...
            var l = n(18), h = n(23), p = this, f = p.as;
            1 === arguments.length || "function" == typeof e ? (r = e, e = {}) : e = l(e), e.attributesToRetrieve = "objectID", e.hitsPerPage = 1e3, e.distinct = !1, this.clearCache();
            var d = this.search(t, e).then(i);
            return r ? void d.then(a, c) : d
        }, r.prototype.browseAll = function (t, e) {
            function r(t) {
                if (!a._stopped) {
                    var e;
                    e = void 0 !== t ? "cursor=" + encodeURIComponent(t) : l, u._jsonRequest({
                        method: "GET",
                        url: "/1/indexes/" + encodeURIComponent(c.indexName) + "/browse?" + e,
                        hostType: "read",
                        callback: i
                    })
                }
            ...
            function i(t, e) {
                if (!a._stopped)return t ? void a._error(t) : (a._result(e), void 0 === e.cursor ? void a._end() : void r(e.cursor))
            }

            "object" == typeof t && (e = t, t = void 0);
            var o = n(17), s = n(25), a = new s, u = this.as, c = this, l = u._getSearchParams(o({}, e || {}, {query: t}), "");
            return r(), a
        }, r.prototype.ttAdapter = function (t) {
            var e = this;
        ...
        }, r.prototype.waitTask = function (t, e) {
            function n() {
                return l._jsonRequest({
                    method: "GET",
                    hostType: "read",
                    url: "/1/indexes/" + encodeURIComponent(c.indexName) + "/task/" + t
                }).then(function (t) {
                    a++;
                    var e = o * a * a;
                    return e > s && (e = s), "published" !== t.status ? l._promise.delay(e).then(n) : t
                })
            }
            ...
            var o = 100, s = 5e3, a = 0, c = this, l = c.as, h = n();
            return e ? void h.then(r, i) : h
        }, r.prototype.clearIndex = function (t) {
            var e = this;
            return this.as._jsonRequest({
                method: "POST",
        ...
        }, r.prototype.getSettings = function (t) {
            var e = this;
            return this.as._jsonRequest({
                method: "GET",
                url: "/1/indexes/" + encodeURIComponent(e.indexName) + "/settings?getVersion=2",
                hostType: "read",
                callback: t
            })
        }, r.prototype.searchSynonyms = function (t, e) {
        ...
        }, r.prototype.saveSynonym = function (t, e, n) {
        ...
        }, r.prototype.getSynonym = function (t, e) {
            return this.as._jsonRequest({
                method: "GET",
        ...
        }, r.prototype.deleteSynonym = function (t, e, n) {
            "function" == typeof e ? (n = e, e = {}) : void 0 === e && (e = {}), void 0 !== e.forwardToSlaves && l();
            var r = e.forwardToSlaves || e.forwardToReplicas ? "true" : "false";
            return this.as._jsonRequest({
                method: "DELETE",
        ...
        }, r.prototype.clearSynonyms = function (t, e) {
        ...
        }, r.prototype.batchSynonyms = function (t, e, n) {
            "function" == typeof e ? (n = e, e = {}) : void 0 === e && (e = {}), void 0 !== e.forwardToSlaves && l();
            var r = e.forwardToSlaves || e.forwardToReplicas ? "true" : "false";
            return this.as._jsonRequest({
                method: "POST",
        ...
        }, r.prototype.setSettings = function (t, e, n) {
            ...
            var i = n(22), o = "Usage: index.addUserKey(arrayOfAcls[, params, callback])";
            if (!i(t))throw new Error(o);
            1 !== arguments.length && "function" != typeof e || (r = e, e = null);
            var s = {acl: t};
            ...
            return this.addUserKey(t, e, n)
        }, a("index.addUserKeyWithValidity()", "index.addUserKey()")), r.prototype.updateUserKey = function (t, e, r, i) {
            var o = n(22), s = "Usage: index.updateUserKey(key, arrayOfAcls[, params, callback])";
            if (!o(e))throw new Error(s);
            2 !== arguments.length && "function" != typeof r || (i = r, r = null);
            var a = {acl: e};
        ...
        t.exports = r, r.prototype.clearCache = function () {
            ...
            var r = n(18), i = n(19), o = "Usage: index.searchForFacetValues({facetName, facetQuery, ...params}[, callback])";
            if (void 0 === t.facetName || void 0 === t.facetQuery)throw new Error(o);
            var s = t.facetName, a = i(r(t), function (t) {
                return "facetName" === t
            }), u = this.as._getSearchParams(a, "");
            return this.as._jsonRequest({
                method: "POST",
        ...
        }, r.prototype.searchFacet = o(function (t, e) {
            return this.searchForFacetValues(t, e)
        }, s("index.searchFacet(params[, callback])", "index.searchForFacetValues(params[, callback])")), r.prototype._search = function (t, e, n, r) {
            return this.as._jsonRequest({
                cache: this.cache,
                method: "POST",
            ...
            var i = n(22), o = n(23), s = "Usage: index.getObjects(arrayOfObjectIDs[, callback])";
        ...
        t.exports = function (t, e) {
            function n() {
                return r || (console.log(e), r = !0), t.apply(this, arguments)
            }
        ...
        "use strict";
        var r = Object.prototype.hasOwnProperty, i = Object.prototype.toString, o = Array.prototype.slice, s = n(21), a = Object.prototype.propertyIsEnumerable, u = !a.call({toString: null}, "toString"), c = a.call(function () {
        }, "prototype"), l = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], h = function (t) {
            var e = t.constructor;
            ...
            var e = null !== t && "object" == typeof t, n = "[object Function]" === i.call(t), o = s(t), a = e && "[object String]" === i.call(t), h = [];
            if (!e && !n && !o)throw new TypeError("Object.keys called on a non-object");
            var p = c && n;
            if (a && t.length > 0 && !r.call(t, 0))for (var f = 0; f < t.length; ++f)h.push(String(f));
            if (o && t.length > 0)for (var m = 0; m < t.length; ++m)h.push(String(m)); else for (var y in t)p && "prototype" === y || !r.call(t, y) || h.push(String(y));
            if (u)for (var g = d(t), v = 0; v < l.length; ++v)g && "constructor" === l[v] || !r.call(t, l[v]) || h.push(l[v]);
            return h
        };
        m.shim = function () {
            if (Object.keys) {
        ...
        t.exports = r;
        var i = n(10), o = n(26).EventEmitter;
        i(r, o), r.prototype.stop = function () {
        ...
        function r(t, e, r) {
            var o = n(29)("algoliasearch"), s = n(18), a = n(22), c = n(23), l = "Usage: algoliasearch(applicationID, apiKey, opts)";
            ...
            if (this._timeouts = r.timeouts || {
                    ...
                    read: 2e3,
                    write: 3e4
                }, r.timeout && (this._timeouts.connect = this._timeouts.read = this._timeouts.write = r.timeout), /:$/.test(h) || (h += ":"), "http:" !== r.protocol && "https:" !== r.protocol)throw new u.AlgoliaSearchError("protocol must be `http:` or `https:` (was `" + r.protocol + "`)");
            if (this._checkAppIdData(), r.hosts)a(r.hosts) ? (this.hosts.read = s(r.hosts), this.hosts.write = s(r.hosts)) : (this.hosts.read = s(r.hosts.read), this.hosts.write = s(r.hosts.write)); else {
        ...
        t.exports = r;
        var u = n(13), c = n(24), l = n(11), h = n(28), p = 500, f = {NODE_ENV: "production"}.RESET_APP_DATA_TIMER && parseInt({NODE_ENV: "production"}.RESET_APP_DATA_TIMER, 10) || 12e4;
        r.prototype.initIndex = function (t) {
            return new l(this, t)
            ...
            function e(n, c) {
                function p(t) {
                    ...
                    var n = 2 === Math.floor(e / 100), o = new Date;
                    if (g.push({
                            currentHost: T,
                            headers: a(i),
                            content: r || null,
                            ...
                            duration: o - x,
                            statusCode: e
                        }), n)return f._useCache && h && (h[_] = t.responseText), t.body;
                    var l = 4 !== Math.floor(e / 100);
                    if (l)return d += 1, b();
                    s("unrecoverable error");
                    var p = new u.AlgoliaSearchError(t.body && t.body.message, {debugData: g, statusCode: e});
                    return f._promise.reject(p)
                }
                ...
                function v(e) {
                    ...
                    return g.push({
                        ...
                        endTime: n,
                        duration: n - x
                    }), e instanceof u.AlgoliaSearchError || (e = new u.Unknown(e && e.message, e)), d += 1, e instanceof u.Unknown || e instanceof u.UnparsableJSON || d >= f.hosts[t.hostType].length && (m || !y) ? (e.debugData = g, f._promise.reject(e)) : e instanceof u.RequestTimeout ? w() : b()
                }

                function b() {
                    return s("retrying request"), f._incrementHostIndex(t.hostType), e(n, c)
                }

                function w() {
                    return s("retrying request with higher timeout"), f._incrementHostIndex(t.hostType), f._incrementTimeoutMultipler(), c.timeouts = f._getTimeoutsForRequest(t.hostType), e(n, c)
                }
                ...
                return s("method: %s, url: %s, headers: %j, timeouts: %d", C.method, S, C.headers, C.timeouts), n === f._request.fallback && s("using fallback"), n.call(f, S, C).then(p, v)
            }

            this._checkAppIdData();
            var r, i, s = n(29)("algoliasearch:" + t.url), l = t.additionalUA || "", h = t.cache, f = this, d = 0, m = !1, y = f._useFallback && f._request.fallback && t.fallback;
            this.apiKey.length > p && void 0 !== t.body && (void 0 !== t.body.params || void 0 !== t.body.requests) ? (t.body.apiKey = this.apiKey, i = this._computeRequestHeaders(l, !1)) : i = this._computeRequestHeaders(l), void 0 !== t.body && (r = o(t.body)), s("request start");
            var g = [], v = e(f._request, {
                url: t.url,
                method: t.method,
                body: r,
                jsonBody: t.body,
            ...
            for (var n in t)null !== n && void 0 !== t[n] && t.hasOwnProperty(n) && (e += "" === e ? "" : "&", e += n + "=" + encodeURIComponent("[object Array]" === Object.prototype.toString.call(t[n]) ? o(t[n]) : t[n]));
            return e
        }, r.prototype._computeRequestHeaders = function (t, e) {
            var r = n(14), i = t ? this._ua + ";" + t : this._ua, o = {
                "x-algolia-agent": i,
                "x-algolia-application-id": this.applicationID
            };
            return e !== !1 && (o["x-algolia-api-key"] = this.apiKey), this.userToken && (o["x-algolia-usertoken"] = this.userToken), this.securityTags && (o["x-algolia-tagfilters"] = this.securityTags), this.extraHeaders && r(this.extraHeaders, function (t) {
                o[t.name] = t.value
            }), o
        }, r.prototype.search = function (t, e, r) {
            var i = n(22), o = n(23), s = "Usage: client.search(arrayOfQueries[, callback])";
            if (!i(t))throw new Error(s);
            ...
            }, c = o(u.requests, function (t, e) {
                return e + "=" + encodeURIComponent("/1/indexes/" + encodeURIComponent(t.indexName) + "?" + t.params)
            }).join("&"), l = "/1/indexes/*/queries";
            return void 0 !== e.strategy && (l += "?strategy=" + e.strategy), this._jsonRequest({
                cache: this.cache,
                method: "POST",
                url: l,
                body: u,
            ...
            return e.hostIndexes = {
                read: 0,
                write: 0
            }, e.timeoutMultiplier = 1, e.shuffleResult = e.shuffleResult || s([1, 2, 3]), this._setAppIdData(e)
            ...
            var e = n(14), r = this._getAppIdData();
            ...
            var r = n(18), i = r(this._hostIndexes);
        ...
        (function (e) {
            function r(t, e) {
                return u("localStorage failed with", e), s(), a = l, a.get(t)
            }
            ...
            var a, u = n(29)("algoliasearch:src/hostIndexState.js"), c = "algoliasearch-client-js", l = {
                state: {},
                set: function (t, e) {
        ...
        (function (r) {
            ...
            function u() {
                ...
                if ("undefined" != typeof r && "env"in r)return {NODE_ENV: "production"}.DEBUG
            }
            ...
            e = t.exports = n(31), e.log = s, e.formatArgs = o, e.save = a, e.load = u, e.useColors = i, e.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : c(), e.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], e.formatters.j = function (t) {
                try {
        ...
        function s() {
            m && f && (m = !1, f.length ? d = f.concat(d) : y = -1, d.length && a())
        }
        ...
        e = t.exports = i.debug = i, e.coerce = u, e.disable = s, e.enable = o, e.enabled = a, e.humanize = n(32), e.names = [], e.skips = [], e.formatters = {};
        var c, l = 0
    }, function (t, e) {
        function n(t) {
        ...
        var s = 1e3, a = 60 * s, u = 60 * a, c = 24 * u, l = 365.25 * c;
        t.exports = function (t, e) {
            e = e || {};
            var o = typeof t;
        ...
        "use strict";
        var r = n(34), i = r.Promise || n(35).Promise;
        t.exports = function (t, e) {
            function o(t, e, r) {
                var i = n(18), a = n(41);
            ...
            var a = n(10), u = n(13), c = n(37), l = n(39), h = n(40);
            e = e || "", o.version = n(42), o.ua = "Algolia for vanilla JavaScript " + e + o.version, o.initPlaces = h(o), r.__algolia = {
                debug: n(29),
                algoliasearch: o
            };
            var p = {hasXMLHttpRequest: "XMLHttpRequest"in r, hasXDomainRequest: "XDomainRequest"in r};
            return p.hasXMLHttpRequest && (p.cors = "withCredentials"in new XMLHttpRequest), a(s, t), s.prototype._request = function (t, e) {
                return new i(function (n, r) {
                    function i() {
                        if (!d) {
                            ...
                            try {
                                t = {
                                    body: JSON.parse(y.responseText),
                                    responseText: y.responseText,
                                    statusCode: y.status,
                                    headers: y.getAllResponseHeaders && y.getAllResponseHeaders() || {}
                                }
                            } catch (e) {
                                t = new u.UnparsableJSON({more: y.responseText})
                            }
                    ...
                    function o(t) {
                        d || (clearTimeout(f), r(new u.Network({more: t})))
                    }

                    function s() {
                        d = !0, y.abort(), r(new u.RequestTimeout)
                    }

                    function a() {
                        g = !0, clearTimeout(f), f = setTimeout(s, e.timeouts.complete)
                    }
                    ...
                    t = c(t, e.headers);
                    var f, d, m = e.body, y = p.cors ? new XMLHttpRequest : new XDomainRequest, g = !1;
                    f = setTimeout(s, e.timeouts.connect), y.onprogress = l, "onreadystatechange"in y && (y.onreadystatechange = h), y.onload = i, y.onerror = o, y instanceof XMLHttpRequest ? y.open(e.method, t, !0) : y.open(e.method, t), p.cors && (m && ("POST" === e.method ? y.setRequestHeader("content-type", "application/x-www-form-urlencoded") : y.setRequestHeader("content-type", "application/json")), y.setRequestHeader("accept", "application/json")), y.send(m)
                })
        ...
        (function (e, r) {
            !function (e, n) {
                ...
                function c() {
                    var t = 0, e = new Y(p), n = document.createTextNode("");
                ...
                function f() {
                    try {
                        var t = n(36);
                        return Q = t.runOnLoop || t.runOnContext, u()
                    } catch (t) {
                        return h()
                    }
                }
                ...
                function d(t, e) {
                    var n = arguments, r = this, i = new this.constructor(y);
                    void 0 === i[it] && D(i);
                    var o = r._state;
                    return o ? !function () {
                        var t = n[o - 1];
                ...
                function x(t, e) {
                    e._state === st ? E(t, e._result) : e._state === at ? O(t, e._result) : A(e, void 0, function (e) {
                        return S(t, e)
                    }, function (e) {
                        return O(t, e)
                    })
                ...
                function T(t, e, n) {
                    e.constructor === t.constructor && n === d && e.constructor.resolve === m ? x(t, e) : n === ut ? O(t, ut.error) : void 0 === n ? E(t, e) : i(n) ? _(t, e, n) : E(t, e)
                }

                function S(e, n) {
                    e === n ? O(e, g()) : t(n) ? T(e, n, b(n)) : E(e, n)
                }
                ...
                function E(t, e) {
                    t._state === ot && (t._result = e, t._state = st, 0 !== t._subscribers.length && G(k, t))
                }

                function O(t, e) {
                    t._state === ot && (t._state = at, t._result = e, G(C, t))
                }

                function A(t, e, n, r) {
                    var i = t._subscribers, o = i.length;
                    t._onerror = null, i[o] = e, i[o + st] = n, i[o + at] = r, 0 === o && t._state && G(k, t)
                }

                function k(t) {
                    var e = t._subscribers, n = t._state;
                    if (0 !== e.length) {
                        for (var r = void 0, i = void 0, o = t._result, s = 0; s < e.length; s += 3)r = e[s], i = e[s + n], r ? N(n, r, i, o) : i(o);
                ...
                function N(t, e, n, r) {
                    ...
                    if (o) {
                        if (s = I(n, r), s === ct ? (c = !0, a = s.error, s = null) : u = !0, e === s)return void O(e, v())
                    } else s = r, u = !0;
                    e._state !== ot || (o && u ? S(e, s) : c ? O(e, a) : t === st ? E(e, s) : t === at && O(e, s))
                }
                ...
                function q(t, e) {
                    this._instanceConstructor = t, this.promise = new t(y), this.promise[it] || D(this.promise), J(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? E(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && E(this.promise, this._result))) : O(this.promise, $())
                }
                ...
                function B(t) {
                    this[it] = P(), this._result = this._state = void 0, this._subscribers = [], y !== t && ("function" != typeof t && M(), this instanceof B ? R(this, t) : F())
                }
                ...
                var J = K, z = 0, Q = void 0, Z = void 0, G = function (t, e) {
                    nt[z] = t, nt[z + 1] = e, z += 2, 2 === z && (Z ? Z(p) : rt())
                }, X = "undefined" != typeof window ? window : void 0, W = X || {}, Y = W.MutationObserver || W.WebKitMutationObserver, tt = "undefined" == typeof self && "undefined" != typeof e && "[object process]" === {}.toString.call(e), et = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, nt = new Array(1e3), rt = void 0;
                rt = tt ? a() : Y ? c() : et ? l() : void 0 === X ? f() : h();
                var it = Math.random().toString(36).substring(16), ot = void 0, st = 1, at = 2, ut = new j, ct = new j, lt = 0;
                return q.prototype._enumerate = function () {
                    ...
                    if (r === m) {
                        var i = b(t);
                        if (i === d && t._state !== ot)this._settledAt(t._state, e, t._result); else if ("function" != typeof i)this._remaining--, this._result[e] = t; else if (n === B) {
                            var o = new n(y);
                    ...
                    var r = this.promise;
                    r._state === ot && (this._remaining--, t === at ? O(r, n) : this._result[e] = n), 0 === this._remaining && E(r, this._result)
                ...
                }, B.all = U, B.race = L, B.resolve = m, B.reject = H, B._setScheduler = o, B._setAsap = s, B._asap = G, B.prototype = {
                    constructor: B,
                    then: d,
                    catch: function (t) {
        ...
        t.exports = function (t, e, s, a) {
            return e = e || "&", s = s || "=", null === t && (t = void 0), "object" == typeof t ? n(o(t), function (o) {
                var a = encodeURIComponent(r(o)) + s;
                return i(t[o]) ? n(t[o], function (t) {
        ...
        function r(t, e, n) {
            function r() {
                e.debug("JSONP: success"), y || p || (y = !0, h || (e.debug("JSONP: Fail. Script loaded but did not call the callback"), a(), n(new i.JSONPScriptFail)))
            }
            ...
            function a() {
                clearTimeout(g), d.onload = null, d.onreadystatechange = null, d.onerror = null, f.removeChild(d)
            }
            ...
            function l() {
                e.debug("JSONP: Script error"), y || p || (a(), n(new i.JSONPScriptError))
            }
            ...
            var h = !1, p = !1;
            o += 1;
            var f = document.getElementsByTagName("head")[0], d = document.createElement("script"), m = "algoliaJSONP_" + o, y = !1;
            window[m] = function (t) {
                return u(), p ? void e.debug("JSONP: Late answer, ignoring") : (h = !0, a(), void n(null, {body: t}))
            }, t += "&callback=" + m, e.jsonBody && e.jsonBody.params && (t += "&" + e.jsonBody.params);
            var g = setTimeout(c, e.timeouts.complete);
            d.onreadystatechange = s, d.onload = r, d.onerror = l, d.async = !0, d.defer = !0, d.src = t, f.appendChild(d)
        }
        ...
        function r(t) {
            return function (e, r, o) {
                ...
                var a = t(e, r, o), u = a.initIndex("places");
        ...
        function r(t, e, n, r) {
            ...
            var o = i(t).each(function (t, o) {
                var s = i(o), l = new c({el: s}), h = r || new u({
                        input: s,
                        eventBus: l,
            ...
            return o.autocomplete = {}, s.each(["open", "close", "getVal", "setVal", "destroy"], function (t) {
                o.autocomplete[t] = function () {
                    var e, n = arguments;
                    return o.each(function (r, o) {
                        var s = i(o).data(a);
                        e = s[t].apply(s, n)
                    }), e
                }
        ...
        var a = "aaAutocomplete", u = n(48), c = n(49);
        r.sources = u.sources;
        var l = "autocomplete"in window, h = window.autocomplete;
        r.noConflict = function () {
            return l ? window.autocomplete = h : delete window.autocomplete, r
        }, t.exports = r
    }, function (t, e) {
        !function (e, n) {
            t.exports = n(e)
            ...
            var e = function () {
                function e(t) {
                    return null == t ? String(t) : Z[G.call(t)] || "object"
                }
                ...
                function f(t) {
                    var e, n;
                    return P[t] || (e = R.createElement(t), R.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), P[t] = n), P[t]
                }
                ...
                function y(t, e, n) {
                    for (S in e)n && (s(e[S]) || tt(e[S])) ? (s(e[S]) && !s(t[S]) && (t[S] = {}), tt(e[S]) && !tt(t[S]) && (t[S] = []), y(t[S], e[S], n)) : e[S] !== T && (t[S] = e[S])
                }
                ...
                function w(t, e) {
                    var n = t.className || "", r = n && n.baseVal !== T;
                ...
                var T, S, C, E, O, A, k = [], j = k.concat, I = k.filter, N = k.slice, R = t.document, P = {}, D = {}, q = {
                    "column-count": 1,
                    columns: 1,
                    "font-weight": 1,
                    "line-height": 1,
                    ...
                    "z-index": 1,
                    zoom: 1
                }, $ = /^\s*<(\w+|!)[^>]*>/, U = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, L = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, H = /^(?:body|html)$/i, M = /([A-Z])/g, F = ["val", "css", "html", "text", "data", "width", "height", "offset"], B = ["after", "prepend", "before", "append"], V = R.createElement("table"), K = R.createElement("tr"), J = {
                    ...
                    th: K,
                    "*": R.createElement("div")
                }, z = /complete|loaded|interactive/, Q = /^[\w-]*$/, Z = {}, G = Z.toString, X = {}, W = R.createElement("div"), Y = {
                    tabindex: "tabIndex",
                    readonly: "readOnly",
                    for: "htmlFor",
                    class: "className",
                ...
                return X.matches = function (t, e) {
                    ...
                    var r, i, o;
                    return U.test(t) && (r = C(R.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(L, "<$1></$2>")), e === T && (e = $.test(t) && RegExp.$1), e in J || (e = "*"), o = J[e], o.innerHTML = "" + t, r = C.each(N.call(o.childNodes), function () {
                        o.removeChild(this)
                    ...
                    var r;
                    if (!t)return X.Z();
                    if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && $.test(t))r = X.fragment(t, RegExp.$1, e), t = null; else {
                        if (e !== T)return C(e).find(t);
                        r = X.qsa(R, t)
                    } else {
                        if (n(t))return C(R).ready(t);
                        if (X.isZ(t))return t;
                        if (tt(t))r = u(t); else if (o(t))r = [t], t = null; else if ($.test(t))r = X.fragment(t.trim(), RegExp.$1, e), t = null; else {
                            if (e !== T)return C(e).find(t);
                            r = X.qsa(R, t)
                        }
                    }
                    ...
                    var n, r = "#" == e[0], i = !r && "." == e[0], o = r || i ? e.slice(1) : e, s = Q.test(o);
                ...
                }, C.contains = R.documentElement.contains ? function (t, e) {
                ...
                }, C.camelCase = O, C.trim = function (t) {
                    ...
                    concat: function () {
                        ...
                        return j.apply(X.isZ(this) ? this.toArray() : this, n)
                    },
                    map: function (t) {
                    ...
                    ready: function (t) {
                        return z.test(R.readyState) && R.body ? t(C) : R.addEventListener("DOMContentLoaded", function () {
                            t(C)
                        }, !1), this
                    },
                    get: function (t) {
                    ...
                    filter: function (t) {
                        return n(t) ? this.not(this.not(t)) : C(I.call(this, function (e) {
                    ...
                    closest: function (t, e) {
                        ...
                        return this.each(function (o, s) {
                            for (; s && !(r ? r.indexOf(s) >= 0 : X.matches(s, t));)s = s !== e && !i(s) && s.parentNode;
                    ...
                    siblings: function (t) {
                        return g(this.map(function (t, e) {
                            return I.call(d(e.parentNode), function (t) {
                                return t !== e
                            })
                        }), t)
                    },
                    ...
                    attr: function (t, e) {
                        ...
                        return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                            if (1 === this.nodeType)if (o(t))for (S in t)b(this, S, t[S]); else b(this, t, v(this, e, n, this.getAttribute(t)))
                    ...
                    removeProp: function (t) {
                        return t = Y[t] || t, this.each(function () {
                            delete this[t]
                        })
                    },
                    data: function (t, e) {
                        var n = "data-" + t.replace(M, "-$1").toLowerCase(), r = 1 in arguments ? this.attr(n, e) : this.attr(n);
                        return null !== r ? _(r) : T
                    },
                    val: function (t) {
                    ...
                    offset: function (e) {
                        if (e)return this.each(function (t) {
                            var n = C(this), r = v(this, e, t, n.offset()), i = n.offsetParent().offset(), o = {
                                top: r.top - i.top,
                                left: r.left - i.left
                            };
                        ...
                        if (R.documentElement !== this[0] && !C.contains(R.documentElement, this[0]))return {
                            top: 0,
                            left: 0
                        };
                        ...
                        if (arguments.length < 2) {
                            ...
                            if (tt(t)) {
                                ...
                                return C.each(t, function (t, e) {
                                    i[e] = r.style[O(e)] || o.getPropertyValue(e)
                                }), i
                            }
                        }
                        var s = "";
                        if ("string" == e(t))n || 0 === n ? s = l(t) + ":" + p(t, n) : this.each(function () {
                            this.style.removeProperty(l(t))
                        }); else for (S in t)t[S] || 0 === t[S] ? s += l(S) + ":" + p(S, t[S]) + ";" : this.each(function () {
                        ...
                        return t ? this.each(function (e) {
                            if ("className"in this) {
                                ...
                                r.split(/\s+/g).forEach(function (t) {
                                    C(this).hasClass(t) || E.push(t)
                                }, this), E.length && w(this, n + (n ? " " : "") + E.join(" "))
                            }
                        }) : this
                    },
                    removeClass: function (t) {
                        return this.each(function (e) {
                            if ("className"in this) {
                                ...
                                E = w(this), v(this, t, e, E).split(/\s+/g).forEach(function (t) {
                                    E = E.replace(h(t), " ")
                                }), w(this, E.trim())
                            }
                        })
                    ...
                    toggleClass: function (t, e) {
                        return t ? this.each(function (n) {
                            var r = C(this), i = v(this, t, n, w(this));
                    ...
                    position: function () {
                        if (this.length) {
                            var t = this[0], e = this.offsetParent(), n = this.offset(), r = H.test(e[0].nodeName) ? {
                                top: 0,
                                left: 0
                            } : e.offset();
                    ...
                    offsetParent: function () {
                        return this.map(function () {
                            for (var t = this.offsetParent || R.body; t && !H.test(t.nodeName) && "static" == C(t).css("position");)t = t.offsetParent;
                            return t
                        })
                    }
                    ...
                    C.fn[n] = function () {
                        var n, o, s = C.map(arguments, function (t) {
                            ...
                            return n = e(t), "array" == n ? (t.forEach(function (t) {
                                return t.nodeType !== T ? r.push(t) : C.zepto.isZ(t) ? r = r.concat(t.get()) : void(r = r.concat(X.fragment(t)))
                        ...
                        return s.length < 1 ? this : this.each(function (e, n) {
                            ...
                            var u = C.contains(R.documentElement, o);
                ...
                }), X.Z.prototype = m.prototype = C.fn, X.uniq = A, X.deserializeValue = _, C.zepto = X, C
            }();
            return function (e) {
                function n(t) {
                ...
                function u(t, r, o, u, c, h, f) {
                    ...
                    r.split(/\s/).forEach(function (n) {
                        ...
                        }, r.i = m.length, m.push(r), "addEventListener"in t && t.addEventListener(a(r.e), r.proxy, s(r, f))
                    })
                }
                ...
                var p, f = 1, d = Array.prototype.slice, m = e.isFunction, y = function (t) {
                    return "string" == typeof t
                }, g = {}, v = {}, b = "onfocusin"in t, w = {
                    focus: "focusin",
                    blur: "focusout"
                ...
                v.click = v.mousedown = v.mouseup = v.mousemove = "MouseEvents", e.event = {
                    ...
                    if (y(r))return i ? (i.unshift(t[r], t), e.proxy.apply(null, i)) : e.proxy(t[r], t);
                ...
                var x = function () {
                    ...
                    return !1
                }, S = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/, C = {
                ...
                e.fn.delegate = function (t, e, n) {
                    ...
                    var s, a, l = this;
                    return t && !y(t) ? (e.each(t, function (t, e) {
                        l.on(t, n, r, e, o)
                    }), l) : (y(n) || m(i) || i === !1 || (i = r, r = n, n = p), i !== p && r !== !1 || (i = r, r = p), i === !1 && (i = T), l.each(function (l, p) {
                        o && (s = function (t) {
                            return c(p, t.type, i), i.apply(this, arguments)
                        }), n && (a = function (t) {
                            var r, o = e(t.target).closest(n, p).get(0);
                            if (o && o !== p)return r = e.extend(h(t), {
                                currentTarget: o,
                                liveFired: p
                    ...
                    return t && !y(t) ? (e.each(t, function (t, e) {
                        i.off(t, n, e)
                    }), i) : (y(n) || m(r) || r === !1 || (r = n, n = p), r === !1 && (r = T), i.each(function () {
                        c(this, t, r, n)
                    }))
                }, e.fn.trigger = function (t, n) {
                    return t = y(t) || e.isPlainObject(t) ? e.Event(t) : l(t), t._args = n, this.each(function () {
                    ...
                    return this.each(function (s, a) {
                        i = h(y(t) ? e.Event(t) : t), i._args = n, i.target = a, e.each(r(a, t.type || t), function (t, e) {
        ...
        t.exports = {
            ...
            every: function (t, e) {
                ...
                return t ? (this.each(t, function (r, i) {
                    if (n = e.call(null, r, i, t), !n)return !1
                }), !!n) : n
            },
            any: function (t, e) {
                var n = !1;
        ...
        function r(t) {
            var e, n;
            if (t = t || {}, t.input || u.error("missing input"), this.isActivated = !1, this.debug = !!t.debug, this.autoselect = !!t.autoselect, this.autoselectOnBlur = !!t.autoselectOnBlur, this.openOnFocus = !!t.openOnFocus, this.minLength = u.isNumber(t.minLength) ? t.minLength : 1, t.hint = !!t.hint, t.hint && t.appendTo)throw new Error("[autocomplete.js] hint and appendTo options can't be used at the same time");
            this.css = t.css = u.mixin({}, d, t.appendTo ? d.appendTo : {}), this.cssClasses = t.cssClasses = u.mixin({}, d.defaultClasses, t.cssClasses || {}), this.listboxId = t.listboxId = [this.cssClasses.root, "listbox", u.getUniqueId()].join("-");
            var o = i(t);
            this.$node = o.wrapper;
        ...
        function i(t) {
            ...
            var s = f.dropdown.replace("%PREFIX%", t.cssClasses.prefix).replace("%DROPDOWN_MENU%", t.cssClasses.dropdownMenu);
        ...
        var a = "aaAttrs", u = n(47), c = n(46), l = n(49), h = n(50), p = n(58), f = n(60), d = n(61);
        u.mixin(r.prototype, {
            _bindKeyboardShortcuts: function (t) {
                if (t.keyboardShortcuts) {
                    ...
                    u.each(t.keyboardShortcuts, function (t) {
                        ...
                        if (!r.isContentEditable && "INPUT" !== i && "SELECT" !== i && "TEXTAREA" !== i) {
                            ...
                            n.indexOf(o) !== -1 && (e.focus(), t.stopPropagation(), t.preventDefault())
                        }
                    })
                }
                ...
                this.$node.css("width", t.width + "px"), this.$node.css("top", "0px"), this.$node.css("left", "0px");
                ...
                "undefined" != typeof t.value && this.input.setQuery(t.value), this.input.setInputValue(t.value, !0), this._setLanguageDirection();
                var e = this.eventBus.trigger("selected", t.raw, t.datasetName);
                e.isDefaultPrevented() === !1 && (this.dropdown.close(), u.defer(u.bind(this.dropdown.empty, this.dropdown)))
            }, open: function () {
                if (!this.isActivated) {
        ...
        }), r.Dropdown = p, r.Input = h, r.sources = n(62), t.exports = r
    }, function (t, e, n) {
        "use strict";
        function r(t) {
        ...
        var i = "autocomplete:", o = n(47), s = n(46);
        o.mixin(r.prototype, {
            trigger: function (t) {
                var e = [].slice.call(arguments, 1), n = o.Event(i + t);
        ...
        r.normalizeQuery = function (t) {
            ...
            _onBlur: function () {
                ...
                "undefined" == typeof t && (t = this.query), this.$input.val(t), e ? this.clearHint() : this._checkInputValue()
            }, expand: function () {
                ...
                var t, e, n, r;
                t = this.getInputValue(), e = this.getHint(), n = t !== e && 0 === e.indexOf(t), r = "" !== t && n && !this.hasOverflow(), r || this.clearHint()
        ...
        function a(t) {
            var e, n, r, i, o;
            if (!this._callbacks)return this;
            for (t = t.split(h), r = [].slice.call(arguments, 1); (e = t.shift()) && (n = this._callbacks[e]);)i = u(n.sync, this, [e].concat(r)), o = u(n.async, this, [e].concat(r)), i() && l(o);
            return this
        }

        function u(t, e, n) {
            function r() {
                for (var r, i = 0, o = t.length; !r && i < o; i += 1)r = t[i].apply(e, n) === !1;
                return !r
            }
        ...
        function s(t) {
            var e = new Array(arguments.length - 1);
            if (arguments.length > 1)for (var n = 1; n < arguments.length; n++)e[n - 1] = arguments[n];
            p.push(new o(t, e)), f || a || (f = !0, c())
        }

        for (var a, u, c, l = [n(53), n(54), n(55), n(56), n(57)], h = -1, p = [], f = !1, d = -1, m = l.length; ++d < m;)if (l[d] && l[d].test && l[d].test()) {
            c = l[d].install(i);
            break
        }
        ...
        (function (t) {
            "use strict";
            e.test = function () {
                return "undefined" != typeof t && !t.browser
        ...
        (function (t) {
            "use strict";
            e.test = function () {
                return !t.setImmediate && "undefined" != typeof t.MessageChannel
            }, e.install = function (e) {
        ...
        function r(t) {
            var e, n, r, a = this;
            t = t || {}, t.menu || o.error("menu is required"), o.isArray(t.datasets) || o.isObject(t.datasets) || o.error("1 or more datasets required"), t.datasets || o.error("datasets is required"), this.isOpen = !1, this.isEmpty = !0, this.minLength = t.minLength || 0, this.templates = {}, this.appendTo = t.appendTo || !1, this.css = o.mixin({}, c, t.appendTo ? c.appendTo : {}), this.cssClasses = t.cssClasses = o.mixin({}, c.defaultClasses, t.cssClasses || {}), e = o.bind(this._onSuggestionClick, this), n = o.bind(this._onSuggestionMouseEnter, this), r = o.bind(this._onSuggestionMouseLeave, this);
            var u = o.className(this.cssClasses.prefix, this.cssClasses.suggestion);
            this.$menu = s.element(t.menu).on("click.aa", u, e).on("mouseenter.aa", u, n).on("mouseleave.aa", u, r), this.$container = t.appendTo ? t.wrapper : this.$menu, t.templates && t.templates.header && (this.templates.header = o.templatify(t.templates.header), this.$menu.prepend(this.templates.header())), t.templates && t.templates.empty && (this.templates.empty = o.templatify(t.templates.empty), this.$empty = s.element('<div class="' + o.className(this.cssClasses.prefix, this.cssClasses.empty, !0) + '"></div>'), this.$menu.append(this.$empty)), this.datasets = o.map(t.datasets, function (e) {
        ...
        var o = n(47), s = n(46), a = n(51), u = n(59), c = n(61);
        o.mixin(r.prototype, a, {
            _onSuggestionClick: function (t) {
                ...
                if (t.relatedTarget) {
                    var e = s.element(t.relatedTarget);
                    if (e.closest("." + o.className(this.cssClasses.prefix, this.cssClasses.cursor, !0)).length > 0)return
                }
                ...
                } else o.any(this.datasets, r) ? e.length < this.minLength ? this._hide() : this._show() : this._hide(); else this.isOpen && (this.$empty && this.$empty.empty(), e.length >= this.minLength ? this._show() : this._hide());
                ...
                var e, n, r, i;
                if (this.isOpen) {
                    if (n = this._getCursor(), e = this._getSuggestions(), this._removeCursor(), r = e.index(n) + t, r = (r + 1) % (e.length + 1) - 1, r === -1)return void this.trigger("cursorRemoved");
        ...
        "use strict";
        function r(t) {
            t = t || {}, t.templates = t.templates || {}, t.source || l.error("missing source"), t.name && !s(t.name) && l.error("invalid dataset name: " + t.name), this.query = null, this._isEmpty = !0, this.highlight = !!t.highlight, this.name = "undefined" == typeof t.name || null === t.name ? l.getUniqueId() : t.name, this.source = t.source, this.displayFn = i(t.display || t.displayKey), this.templates = o(t.templates, this.displayFn), this.css = l.mixin({}, f, t.appendTo ? f.appendTo : {}), this.cssClasses = l.mixin({}, f.defaultClasses, t.cssClasses || {});
            var e = l.className(this.cssClasses.prefix, this.cssClasses.dataset);
            this.$el = t.$menu && t.$menu.find(e + "-" + this.name).length > 0 ? h.element(t.$menu.find(e + "-" + this.name)[0]) : h.element(p.dataset.replace("%CLASS%", this.name).replace("%PREFIX%", this.cssClasses.prefix).replace("%DATASET%", this.cssClasses.dataset)), this.$menu = t.$menu
        }
        ...
        var a = "aaDataset", u = "aaValue", c = "aaDatum", l = n(47), h = n(46), p = n(60), f = n(61), d = n(51);
        r.extractDatasetName = function (t) {
            ...
            _render: function (t, e) {
                function n() {
                    ...
                    return e = [{query: t, isEmpty: !0}].concat(e), f.templates.empty.apply(this, e)
                }

                function r() {
                    function t(t) {
                        var e, n = p.suggestion.replace("%PREFIX%", o.cssClasses.prefix).replace("%SUGGESTION%", o.cssClasses.suggestion);
                        return e = h.element(n).attr({
                            ...
                            h.element(this).css(o.css.suggestionChild)
                        }), e
                    }

                    var n, r, i = [].slice.call(arguments, 0), o = this, s = p.suggestions.replace("%PREFIX%", this.cssClasses.prefix).replace("%SUGGESTIONS%", this.cssClasses.suggestions);
                    return n = h.element(s).css(this.css.suggestions), r = l.map(e, t), n.append.apply(n, r), n
                }

                function i() {
                    var e = [].slice.call(arguments, 0);
                    return e = [{query: t, isEmpty: !s}].concat(e), f.templates.header.apply(this, e)
                }

                function o() {
                    var e = [].slice.call(arguments, 0);
                    return e = [{query: t, isEmpty: !s}].concat(e), f.templates.footer.apply(this, e)
                }

                if (this.$el) {
                    var s, f = this, d = [].slice.call(arguments, 2);
                    this.$el.empty(), s = e && e.length, this._isEmpty = !s, !s && this.templates.empty ? this.$el.html(n.apply(this, d)).prepend(f.templates.header ? i.apply(this, d) : null).append(f.templates.footer ? o.apply(this, d) : null) : s && this.$el.html(r.apply(this, d)).prepend(f.templates.header ? i.apply(this, d) : null).append(f.templates.footer ? o.apply(this, d) : null), this.$menu && this.$menu.addClass([this.cssClasses.prefix, s ? "with" : "without", this.name].join("-")).removeClass([this.cssClasses.prefix, s ? "without" : "with", this.name].join("-")), this.trigger("rendered", t)
                }
            }, getRoot: function () {
                return this.$el
            }, update: function (t) {
        ...
        "use strict";
        t.exports = {hits: n(63), popularIn: n(64)}
    }, function (t, e, n) {
        "use strict";
        var r = n(47);
        t.exports = function (t, e) {
            function n(n, i) {
                t.search(n, e, function (t, e) {
                    return t ? void r.error(t.message) : void i(e.hits, e)
                })
            }
        ...
        t.exports = function (t, e, n, i) {
            function o(o, u) {
                t.search(o, e, function (t, e) {
                    if (t)return void r.error(t.message);
                    if (e.hits.length > 0) {
                        var o = e.hits[0], c = r.mixin({hitsPerPage: 0}, n);
                        return delete c.source, delete c.index, void a.search(s(o), c, function (t, n) {
                            if (t)return void r.error(t.message);
                            var s = [];
                            if (i.includeAll) {
                                var a = i.allTitle || "All departments";
                                s.push(r.mixin({facet: {value: a, count: n.nbHits}}, r.cloneDeep(o)))
                            }
                            r.each(n.facets, function (t, e) {
                                r.each(t, function (t, n) {
                                    s.push(r.mixin({facet: {facet: e, value: n, count: t}}, r.cloneDeep(o)))
                                })
                            });
                            for (var c = 1; c < e.hits.length; ++c)s.push(e.hits[c]);
                            u(s, e)
                        })
                    }
                    u([])
            ...
            if (!n.source)return r.error("Missing 'source' key");
            var s = r.isFunction(n.source) ? n.source : function (t) {
                return t[n.source]
            };
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = "algolia-docsearch", r = n + "-suggestion", i = n + "-footer", o = {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(67), o = r(i), s = {
            mergeKeyWithParent: function (t, e) {
                if (void 0 === t[e])return t;
                if ("object" != typeof t[e])return t;
                var n = o.default.extend({}, t, t[e]);
                return delete n[e], n
            }, groupBy: function (t, e) {
                var n = {};
                return o.default.each(t, function (t, r) {
                    if (void 0 === r[e])throw new Error("[groupBy]: Object has no key " + e);
                    var i = r[e];
                    "string" == typeof i && (i = i.toLowerCase()), n[i] || (n[i] = []), n[i].push(r)
                }), n
            }, values: function (t) {
            ...
            }, flattenAndFlagFirst: function (t, e) {
                var n = this.values(t).map(function (t) {
            ...
            }, getHighlightedValue: function (t, e) {
                return t._highlightResult && t._highlightResult.hierarchy_camel && t._highlightResult.hierarchy_camel[e] && t._highlightResult.hierarchy_camel[e].matchLevel && "none" !== t._highlightResult.hierarchy_camel[e].matchLevel && t._highlightResult.hierarchy_camel[e].value ? t._highlightResult.hierarchy_camel[e].value : t._highlightResult && t._highlightResult && t._highlightResult[e] && t._highlightResult[e].value ? t._highlightResult[e].value : t[e]
            }, getSnippetedValue: function (t, e) {
                if (!t._snippetResult || !t._snippetResult[e] || !t._snippetResult[e].value)return t[e];
                var n = t._snippetResult[e].value;
                return n[0] !== n[0].toUpperCase() && (n = "…" + n), [".", "!", "?"].indexOf(n[n.length - 1]) === -1 && (n += "…"), n
        ...
        var r = function () {
            ...
            function h(t, e) {
                return "number" != typeof e || R[c(t)] ? e : e + "px"
            }
            ...
            function d(t, e, n) {
                for (x in e)n && (o(e[x]) || X(e[x])) ? (o(e[x]) && !o(t[x]) && (t[x] = {}), X(e[x]) && !X(t[x]) && (t[x] = []), d(t[x], e[x], n)) : e[x] !== _ && (t[x] = e[x])
            }
            ...
            var _, x, T, S, C, E, O = [], A = O.slice, k = O.filter, j = window.document, I = {}, N = {}, R = {
                "column-count": 1,
                columns: 1,
                "font-weight": 1,
                "line-height": 1,
                ...
                "z-index": 1,
                zoom: 1
            }, P = /^\s*<(\w+|!)[^>]*>/, D = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, q = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, $ = /^(?:body|html)$/i, U = /([A-Z])/g, L = ["val", "css", "html", "text", "data", "width", "height", "offset"], H = ["after", "prepend", "before", "append"], M = j.createElement("table"), F = j.createElement("tr"), B = {
                ...
                th: F,
                "*": j.createElement("div")
            }, V = /complete|loaded|interactive/, K = /^[\w-]*$/, J = {}, z = J.toString, Q = {}, Z = j.createElement("div"), G = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                for: "htmlFor",
                class: "className",
            ...
            return Q.matches = function (t, e) {
                ...
                if (n)return n.call(t, e);
                var r, i = t.parentNode, o = !i;
                return o && (i = Z).appendChild(t), r = ~Q.qsa(i, e).indexOf(t), o && Z.removeChild(t), r
            }, C = function (t) {
                return t.replace(/-+(.)?/g, function (t, e) {
                    return e ? e.toUpperCase() : ""
                })
                ...
                var r, i, s;
                return D.test(t) && (r = T(j.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(q, "<$1></$2>")), e === _ && (e = P.test(t) && RegExp.$1), e in B || (e = "*"), s = B[e], s.innerHTML = "" + t, r = T.each(A.call(s.childNodes), function () {
                    s.removeChild(this)
                ...
                var r;
                if (!t)return Q.Z();
                if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && P.test(t))r = Q.fragment(t, RegExp.$1, n), t = null; else {
                    if (n !== _)return T(n).find(t);
                    r = Q.qsa(j, t)
                } else {
                    if (e(t))return T(j).ready(t);
                    if (Q.isZ(t))return t;
                    if (X(t))r = a(t); else if (i(t))r = [t], t = null; else if (P.test(t))r = Q.fragment(t.trim(), RegExp.$1, n), t = null; else {
                        if (n !== _)return T(n).find(t);
                        r = Q.qsa(j, t)
                    }
                }
                ...
                var n, i = "#" == e[0], o = !i && "." == e[0], s = i || o ? e.slice(1) : e, a = K.test(s);
                return r(t) && a && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : A.call(a && !i ? o ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e))
            }, T.contains = j.documentElement.contains ? function (t, e) {
                return t !== e && t.contains(e)
            } : function (t, e) {
                for (; e && (e = e.parentNode);)if (e === t)return !0;
                return !1
            }, T.type = t, T.isFunction = e, T.isWindow = n, T.isArray = X, T.isPlainObject = o, T.isEmptyObject = function (t) {
                var e;
                for (e in t)return !1;
                return !0
                ...
                ready: function (t) {
                    return V.test(j.readyState) && j.body ? t(T) : j.addEventListener("DOMContentLoaded", function () {
                        t(T)
                    }, !1), this
                },
                get: function (t) {
                ...
                filter: function (t) {
                    return e(t) ? this.not(this.not(t)) : T(k.call(this, function (e) {
                ...
                not: function (t) {
                    ...
                    if (e(t) && t.call !== _)this.each(function (e) {
                        ...
                        var r = "string" == typeof t ? this.filter(t) : s(t) && e(t.item) ? A.call(t) : T(t);
                        this.forEach(function (t) {
                ...
                closest: function (t, e) {
                    var n = this[0], i = !1;
                    for ("object" == typeof t && (i = T(t)); n && !(i ? i.indexOf(n) >= 0 : Q.matches(n, t));)n = n !== e && !r(n) && n.parentNode;
                    return T(n)
                },
                parents: function (t) {
                ...
                siblings: function (t) {
                    return m(this.map(function (t, e) {
                        return k.call(f(e.parentNode), function (t) {
                            return t !== e
                        })
                    }), t)
                },
                ...
                attr: function (t, e) {
                    var n;
                    return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                        if (1 === this.nodeType)if (i(t))for (x in t)g(this, x, t[x]); else g(this, t, y(this, e, n, this.getAttribute(t)))
                ...
                data: function (t, e) {
                    var n = "data-" + t.replace(U, "-$1").toLowerCase(), r = 1 in arguments ? this.attr(n, e) : this.attr(n);
                    return null !== r ? b(r) : _
                },
                val: function (t) {
                    return 0 in arguments ? this.each(function (e) {
                ...
                offset: function (t) {
                    if (t)return this.each(function (e) {
                        var n = T(this), r = y(this, t, e, n.offset()), i = n.offsetParent().offset(), o = {
                            top: r.top - i.top,
                            left: r.left - i.left
                        };
                        "static" == n.css("position") && (o.position = "relative"), n.css(o)
                ...
                css: function (e, n) {
                    ...
                    var s = "";
                    if ("string" == t(e))n || 0 === n ? s = c(e) + ":" + h(e, n) : this.each(function () {
                        this.style.removeProperty(c(e))
                    }); else for (x in e)e[x] || 0 === e[x] ? s += c(x) + ":" + h(x, e[x]) + ";" : this.each(function () {
                ...
                addClass: function (t) {
                    return t ? this.each(function (e) {
                        if ("className"in this) {
                            S = [];
                            var n = v(this), r = y(this, t, e, n);
                            r.split(/\s+/g).forEach(function (t) {
                                T(this).hasClass(t) || S.push(t)
                            }, this), S.length && v(this, n + (n ? " " : "") + S.join(" "))
                        }
                    }) : this
                },
                removeClass: function (t) {
                    return this.each(function (e) {
                        if ("className"in this) {
                            if (t === _)return v(this, "");
                            S = v(this), y(this, t, e, S).split(/\s+/g).forEach(function (t) {
                                S = S.replace(l(t), " ")
                            }), v(this, S.trim())
                        }
                    })
                ...
                toggleClass: function (t, e) {
                    return t ? this.each(function (n) {
                        var r = T(this), i = y(this, t, n, v(this));
                        i.split(/\s+/g).forEach(function (t) {
                ...
                offsetParent: function () {
                    return this.map(function () {
                        for (var t = this.offsetParent || j.body; t && !$.test(t.nodeName) && "static" == T(t).css("position");)t = t.offsetParent;
                        return t
                    })
                }
                ...
                T.fn[t] = function (i) {
                    var o, s = this[0];
                    return i === _ ? n(s) ? s["inner" + e] : r(s) ? s.documentElement["scroll" + e] : (o = this.offset()) && o[t] : this.each(function (e) {
                        s = T(this), s.css(t, y(this, i, e, s[t]()))
                    })
                }
                ...
                T.fn[e] = function () {
                    ...
                    return o.length < 1 ? this : this.each(function (t, e) {
                        ...
                        var a = T.contains(j.documentElement, i);
            ...
            }), Q.Z.prototype = T.fn, Q.uniq = E, Q.deserializeValue = b, T.zepto = Q, T
        }();
        window.Zepto = r, void 0 === window.$ && (window.$ = r), function (t) {
            ...
            function a(n, i, a, u, l, p, f) {
                ...
                i.split(/\s/).forEach(function (e) {
                    ...
                    }, i.i = m.length, m.push(i), "addEventListener"in n && n.addEventListener(s(i.e), i.proxy, o(i, f))
                })
            }
            ...
            function u(t, r, i, a, u) {
                ...
                (r || "").split(/\s/).forEach(function (e) {
                    n(t, e, i, a).forEach(function (e) {
                        delete y[c][e.i], "removeEventListener"in t && t.removeEventListener(s(e.e), e.proxy, o(e, u))
                    })
                })
            }
            ...
            function c(e, n) {
                ...
                }), (n.defaultPrevented !== h ? n.defaultPrevented : "returnValue"in n ? n.returnValue === !1 : n.getPreventDefault && n.getPreventDefault()) && (e.isDefaultPrevented = _)), e
            }
            ...
            var h, p = 1, f = Array.prototype.slice, d = t.isFunction, m = function (t) {
                return "string" == typeof t
            }, y = {}, g = {}, v = "onfocusin"in window, b = {
                focus: "focusin",
                blur: "focusout"
            ...
            t.fn.delegate = function (t, e, n) {
                ...
                return e && !m(e) ? (t.each(e, function (t, e) {
                    p.on(t, n, r, e, o)
                }), p) : (m(n) || d(i) || i === !1 || (i = r, r = n, n = h), (d(r) || r === !1) && (i = r, r = h), i === !1 && (i = x), p.each(function (h, p) {
                    o && (s = function (t) {
                        return u(p, t.type, i), i.apply(this, arguments)
                    }), n && (c = function (e) {
                        var r, o = t(e.target).closest(n, p).get(0);
                        if (o && o !== p)return r = t.extend(l(e), {
                            currentTarget: o,
                            liveFired: p
                        }), (s || i).apply(o, [r].concat(f.call(arguments, 1)))
                    }), a(p, e, i, r, n, c || s)
                }))
                ...
                return e && !m(e) ? (t.each(e, function (t, e) {
                    i.off(t, n, e)
                }), i) : (m(n) || d(r) || r === !1 || (r = n, n = h), r === !1 && (r = x), i.each(function () {
                    u(this, e, r, n)
                }))
            ...
            function l(t) {
                return t && (t = t.split(";", 2)[0]), t && (t == T ? "html" : t == x ? "json" : w.test(t) ? "script" : _.test(t) && "xml") || "text"
            }
            ...
            var m, y, g = 0, v = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, w = /^(?:text|application)\/javascript/i, _ = /^(?:text|application)\/xml/i, x = "application/json", T = "text/html", S = /^\s*$/, C = v.createElement("a");
            C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
                if (!("type"in e))return t.ajax(e);
                var r, i, u = e.jsonpCallback, c = (t.isFunction(u) ? u() : u) || "jsonp" + ++g, l = v.createElement("script"), h = window[c], p = function (e) {
                    t(l).triggerHandler("error", e || "abort")
                }, f = {abort: p};
                return n && n.promise(f), t(l).on("load error", function (o, u) {
                    clearTimeout(i), t(l).off().remove(), "error" != o.type && r ? s(r[0], f, e, n) : a(null, u || "error", f, e, n), window[c] = h, r && t.isFunction(h) && h(r[0]), h = r = void 0
                }), o(f, e) === !1 ? (p("abort"), f) : (window[c] = function () {
                    r = arguments
                }, l.src = e.url.replace(/\?(.+)=\?/, "?$1=" + c), v.head.appendChild(l), e.timeout > 0 && (i = setTimeout(function () {
                    p("timeout")
                }, e.timeout)), f)
            }, t.ajaxSettings = {
                type: "GET",
                ...
                r(i), i.crossDomain || (n = v.createElement("a"), n.href = i.url, n.href = n.href, i.crossDomain = C.protocol + "//" + C.host != n.protocol + "//" + n.host), i.url || (i.url = window.location.toString()), p(i);
                var f = i.dataType, d = /\?.+=\?/.test(i.url);
                if (d && (f = "jsonp"), i.cache !== !1 && (e && e.cache === !0 || "script" != f && "jsonp" != f) || (i.url = h(i.url, "_=" + Date.now())), "jsonp" == f)return d || (i.url = h(i.url, i.jsonp ? i.jsonp + "=?" : i.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(i, u);
                var g, b = i.accepts[f], w = {}, _ = function (t, e) {
                    w[t.toLowerCase()] = [t, e]
                }, x = /^([\w-]+:)\/\//.test(i.url) ? RegExp.$1 : window.location.protocol, T = i.xhr(), E = T.setRequestHeader;
                if (u && u.promise(T), i.crossDomain || _("X-Requested-With", "XMLHttpRequest"), _("Accept", b || "*/*"), (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(b)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && _("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)for (y in i.headers)_(y, i.headers[y]);
                if (T.setRequestHeader = _, T.onreadystatechange = function () {
                        if (4 == T.readyState) {
                            T.onreadystatechange = c, clearTimeout(g);
                            var e, n = !1;
                            if (T.status >= 200 && T.status < 300 || 304 == T.status || 0 == T.status && "file:" == x) {
                                f = f || l(i.mimeType || T.getResponseHeader("content-type")), e = T.responseText;
                                try {
                                    "script" == f ? (0, eval)(e) : "xml" == f ? e = T.responseXML : "json" == f && (e = S.test(e) ? null : t.parseJSON(e))
                                } catch (t) {
                                    n = t
                                }
                ...
                if (i.xhrFields)for (y in i.xhrFields)T[y] = i.xhrFields[y];
                var O = !("async"in i) || i.async;
                T.open(i.type, i.url, O, i.username, i.password);
                for (y in w)E.apply(T, w[y]);
                ...
                var i, o = this, s = e.split(/\s/), a = f(e, n, r), u = a.success;
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0}), e.default = "1.5.0", t.exports = e.default
    }])
});
